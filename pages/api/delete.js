  ...
  if (req.method === "POST") {
    ...
    try {
      ...
      await transporter.sendMail({
        ...
        text: "We are sad that you are leaving us, hope we come across again!",
        html: `<!DOCTYPE html>
        <html lang="en">
          <head>
            <meta charset="UTF-8" />
          ...
          <body>
            <div class="container">
              ...
              <div class="content">
                <p class="align">
                  Hey ${account[0].name}, did you want to delete your account?
                </p>
                <p class="text">
      ...
      const remove = await userCollection.deleteOne({
